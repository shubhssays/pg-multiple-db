...
const databaseUsername = process.env.INVENTORY_DB_USERNAME;
const databaseHost = process.env.INVENTORY_DB_HOST;
const databaseName = process.env.INVENTORY_DB_NAME;
const databasePort = process.env.INVENTORY_DB_PORT;
const databasePassword = process.env.INVENTORY_DB_PASSWORD;
...
if (process.argv[2] === 'up') {
  ...
  if (!migration_name) {
    ...
    console.error('Usage: npm run inventory_db-migrate-create [migration_name]');
    process.exit(1);
  }
