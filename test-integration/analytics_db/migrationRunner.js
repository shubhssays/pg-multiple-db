...
const databaseUsername = process.env.ANALYTICS_DB_USERNAME;
const databaseHost = process.env.ANALYTICS_DB_HOST;
const databaseName = process.env.ANALYTICS_DB_NAME;
const databasePort = process.env.ANALYTICS_DB_PORT;
const databasePassword = process.env.ANALYTICS_DB_PASSWORD;
...
if (process.argv[2] === 'up') {
  ...
  if (!migration_name) {
    ...
    console.error('Usage: npm run analytics_db-migrate-create [migration_name]');
    process.exit(1);
  }
