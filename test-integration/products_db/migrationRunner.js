...
const databaseUsername = process.env.PRODUCTS_DB_USERNAME;
const databaseHost = process.env.PRODUCTS_DB_HOST;
const databaseName = process.env.PRODUCTS_DB_NAME;
const databasePort = process.env.PRODUCTS_DB_PORT;
const databasePassword = process.env.PRODUCTS_DB_PASSWORD;
...
if (process.argv[2] === 'up') {
  ...
  if (!migration_name) {
    ...
    console.error('Usage: npm run products_db-migrate-create [migration_name]');
    process.exit(1);
  }
