...
const databaseUsername = process.env.ORDERS_DB_USERNAME;
const databaseHost = process.env.ORDERS_DB_HOST;
const databaseName = process.env.ORDERS_DB_NAME;
const databasePort = process.env.ORDERS_DB_PORT;
const databasePassword = process.env.ORDERS_DB_PASSWORD;
...
if (process.argv[2] === 'up') {
  ...
  if (!migration_name) {
    ...
    console.error('Usage: npm run orders_db-migrate-create [migration_name]');
    process.exit(1);
  }
